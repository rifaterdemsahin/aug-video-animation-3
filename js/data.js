...
window.VIDEO_DATA = {
  ...
  sceneCount: 22,
  sceneDuration: 8,
  totalTurnaroundMinutes: 75, // Capture → Organize → Distill → Express (CODE)
  links: {
  ...
  // Pipeline Stages — CODE: Capture, Organize, Distill, Express
  pipelineStages: [
    {
      id: "stage-1",
      number: "Stage 1",
      name: "Skool Ideation & Setup",
      icon: "🏫",
      phase: "Capture",
      estDuration: "—",
      durationMinutes: 0,
      ...
      status: "ready",
      badge: "Capture",
      shortDesc: "Setup a customer development agent. During week 1, gather information and add that to the course content. Extract classroom topic and prepare raw inputs.",
      deliverables: ["Classroom topic extract", "Raw course inputs", "Customer development agent setup"],
      toolsUsed: ["Skool", "Obsidian"],
      issues: "Stuck at 50 (bottleneck/capacity limit).",
      updates: "Setup a customer development agent. During week 1, gather information and add that to the course content.",
      process: "Extract classroom topic and prepare raw inputs.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-1.html"
    },
    {
      id: "stage-1-5",
      number: "Stage 1.5",
      name: "Gemini & Google Flow Gate",
      icon: "🧪",
      phase: "Capture",
      estDuration: "5 min",
      durationMinutes: 5,
      percentOfTotal: "7%",
      status: "ready",
      badge: "Capture Prelim",
      shortDesc: "Initial sanity check and asset validation. Gemini content validation, asset pre-check for Flow, queue generation (22 8s placeholders), verify pro prompt logic.",
      deliverables: ["Gemini sanity check", "22 8s placeholder queue", "Pro prompt logic verified"],
      toolsUsed: ["Gemini", "Google Flow"],
      updates: "Initial sanity check and asset validation.",
      process: "Sanity check with Gemini content validation, asset pre-check for Flow, queue generation (22 8s placeholders), verify pro prompt logic.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-1-5.html"
    },
    {
      id: "stage-2",
      number: "Stage 2",
      name: "Gemini Script & 8s Prompts",
      icon: "🤖",
      phase: "Organize",
      estDuration: "5 min",
      durationMinutes: 5,
      ...
      status: "ready",
      badge: "Organize",
      shortDesc: "Take the text from Skool and paste it to Gemini; ask it to generate a video voiceover with 8-second animations for Google Flow. Roger Rabbit style; 22 scenes × 8s (176s); 18–22 word VO lines.",
      deliverables: ["22-scene VO script", "22 Google Flow prompts", "18–22 word cadence"],
      toolsUsed: ["Google Flow", "Gemini"],
      updates: "Take the text from Skool and paste it to Gemini; ask it to generate a video voiceover with 8-second animations for Google Flow.",
      process: "Roger Rabbit style setup; 22 scenes × 8s pacing (176s total duration); strict 18–22 word voice-over lines per scene.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-2.html"
    },
    {
      id: "stage-2-5",
      number: "Stage 2.5",
      name: "Simulation & Dual Setup",
      icon: "🪟",
      phase: "Organize",
      estDuration: "5 min",
      durationMinutes: 5,
      ...
      status: "ready",
      badge: "Split-View",
      shortDesc: "Open Gemini and Google Flow side-by-side with Chrome split-screen. Gemini prompt director on one side, Google Flow generation queue on the other.",
      deliverables: ["Split-view cockpit", "Director + queue staging"],
      toolsUsed: ["Google Flow", "Gemini"],
      updates: "Open up Gemini and Google Flow side-by-side with Chrome split-screen feature.",
      process: "Split-view staging — Gemini prompt director on one side, Google Flow generation queue on the other.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-2-5.html"
    },
    {
      id: "stage-3",
      number: "Stage 3",
      name: "Google Flow 8s Generation",
      icon: "🎬",
      phase: "Organize",
      estDuration: "30 min",
      durationMinutes: 30,
      ...
      status: "in_progress",
      badge: "Batch Render",
      shortDesc: "Bulk generate assets and download them from Google Flow. Batch render 22 8s clips using ~330 base credits. Time: 15 min + 15 min.",
      deliverables: ["22 MP4 8s clips", "Downloaded Flow assets"],
      toolsUsed: ["Google Flow", "Canva"],
      updates: "Bulk generate assets and then download them from Google Flow.",
      process: "Batch render 22 8s clips using ~330 base credits.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-3.html"
    },
    {
      id: "stage-qc",
      number: "Stage QC",
      name: "Quality Gate & Gap Audit",
      icon: "🧪",
      phase: "Organize",
      estDuration: "5 min",
      durationMinutes: 5,
      ...
      status: "in_progress",
      badge: "Quality Gate",
      shortDesc: "Create a Canva video document, folder for uploads, and subfolder for used assets. Verify shot list, check timeline gaps, track used assets vs. shot list.",
      deliverables: ["Canva video document", "Uploads folder", "Used-asset subfolder", "Zero-gap shot list"],
      toolsUsed: ["Canva"],
      updates: "Create a Canva video document, create a Canva folder for uploads, create a subfolder for used assets.",
      process: "Critical gate review; verify shot list, check for timeline gaps, track used assets vs. shot list.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-qc.html"
    },
    {
      id: "stage-4",
      number: "Stage 4",
      name: "Canva 3-Section Timeline",
      icon: "🎨",
      phase: "Organize",
      estDuration: "5 min",
      durationMinutes: 5,
      ...
      status: "in_progress",
      badge: "Timeline",
      shortDesc: "Place assets on the timeline, check with post-it notes. Bulk paste 22 8s placeholders into the layout; set video as background across sections.",
      deliverables: ["22 placeholders on timeline", "Video as background", "Post-it shot checks"],
      toolsUsed: ["Canva"],
      updates: "Place assets on the timeline, check with post-it notes.",
      process: "Bulk paste 22 8s placeholders into the layout; set video as background across sections.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-4.html"
    },
    {
      id: "stage-4-5",
      number: "Stage 4.5",
      ...
      status: "ready",
      badge: "Distill",
      shortDesc: "Ask AI to review and sanity check the voiceover; add captions. 8s countdown loop sync; metronome pacing; verify authentic VO/stamp sync.",
      deliverables: ["Sanity-checked VO", "Captions", "8s metronome lock"],
      toolsUsed: ["fal.ai"],
      issues: "Needs to be placed earlier in the process to prevent redo work.",
      updates: "Ask AI to review and sanity check the voiceover; add captions.",
      process: "8s countdown loop sync; metronome pacing check; verify authentic VO/stamp sync.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-4-5.html"
    },
    {
      id: "stage-vo",
      number: "Stage VO",
      name: "Technical Workflow & Voice Sync",
      icon: "🧬",
      phase: "Distill",
      estDuration: "10 min",
      durationMinutes: 10,
      ...
      status: "ready",
      badge: "Voice Clone",
      shortDesc: "Add voice clones, check captions and mismatches, speed up or slow down animations to line up. Alignment of reference audio, waveform check, pacing adjustments. Time: 5 + 5 min.",
      deliverables: ["Cloned VO track", "Caption/mismatch pass", "Pacing alignment"],
      toolsUsed: ["ElevenLabs", "fal.ai"],
      issues: "Use cloned voice with fal.ai.",
      updates: "Add voice clones, check captions and mismatches, speed up or slow down animations to line up.",
      process: "Voice cloning process; alignment of reference audio, waveform check, and pacing adjustments.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-vo.html"
    },
    {
      id: "stage-5",
      number: "Stage 5",
      ...
      status: "ready",
      badge: "Express",
      shortDesc: "Export and add videos natively to their environments; pin the Skool link. Export 1080p 60fps MP4; generate YouTube description with 22 chapters; distribute across YouTube, LinkedIn, and Skool Flywheel.",
      deliverables: ["1080p 60fps MP4", "YouTube 22 chapters", "LinkedIn + Skool pin"],
      toolsUsed: ["YouTube Studio"],
      updates: "Export and add videos natively to their environments; pin the Skool link.",
      process: "Export final render (1080p, 60fps, MP4); generate YouTube description with 22 chapters; distribute across YouTube, LinkedIn, and Skool Flywheel.",
      canvaEmbed: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view?embed",
      canvaView: "https://www.canva.com/design/DAHTV1XbvSs/xCsQKBeG5DDTyOxMwafRgw/view",
      pageLink: "stage-5.html"
    }
  ],
  ...
  distinctPages: [
    {
      ...
      category: "🎬 Production",
      badge: "Issues",
      whatHappens: "Issue log and visual pipeline feedback for the CODE production workflow (Capture, Organize, Distill, Express). Record blockers, times, and notes against each stage.",
      keyFeatures: [
        "Per-stage issues log aligned to CODE phases",
        "Editable durations and process notes",
        "Visual Canva activity diagram",
        "Copy / export all pipeline feedback"
      ],
      actionText: "Open Feedback",
      url: "index.html"
    },
    {
      id: "page-pipeline",
      ...
      category: "🎬 Production",
      badge: "CODE",
      whatHappens: "CODE production pipeline: Capture, Organize, Distill, Express — with associated stages, execution times, updates, issues, and tools.",
      keyFeatures: [
  ...
  chromeTabs: [
    ...
    { category: "Google Workspace / Cloud", title: "Google Flow - 25 Aug, 1", icon: "🎥", platform: "Google Flow (Labs)", role: "AI video generation engine rendering 8-second isometric motion graphic slices (15 credits per generation)." },
    { category: "Google Gemini", title: "Building a Token-Managing IDE - Google Gemini", icon: "✦", platform: "Gemini AI Director", role: "Master Gemini session generating 22 scenes x 8s visual prompt specifications and synchronized VO scripts." },
    { category: "Google Gemini", title: "Building a Token-Managing IDE - Google Gemini", icon: "✦", platform: "Gemini AI Iteration", role: "Active prompt refinement, word-count validation (18–22 words), and script continuity verification." },
    { category: "Canva / Video Player", title: "aug 3 video - Video", icon: "📹", platform: "Canva Asset Staging", role: "Secondary Canva workspace for asset library uploads, layer reordering, and timeline transitions." },
    { category: "Google Workspace / Cloud", title: "Google Flow - 25 Aug, 1", icon: "🎥", platform: "Google Flow Render Queue", role: "Active Google Flow render stream with 'Approve, do not ask again' enabled for batch rendering." },
    { category: "YouTube Studio", title: "Community - YouTube Studio", icon: "▶️", platform: "YouTube Studio", role: "Audience engagement, 22-scene timestamp chapter uploads, and video publication management." },
    { category: "GitHub", title: "aug-video-animation-3/3_Simulation/prod_stage_read_a", icon: "🐙", platform: "GitHub Repository", role: "Sliding Post-it simulation screenshot reference for timeline gap detection." },
    { category: "GitHub", title: "rifaterdemsahin/roger-rabbit: Animation in real world", icon: "🐙", platform: "GitHub Repository", role: "Roger Rabbit signature format specification (blending real IDE captures with cartoon and La Linea line overlays)." },
    { category: "Skool", title: "🌱 Become the person who does what they say they will", icon: "🎴", platform: "Skool Community", role: "Community discussion, student commitment log, and peer accountability flywheel." },
    { category: "Web App / Website", title: "3-Minute AI Animation Video Production Suite 🎬 | Helpe", icon: "🌐", platform: "GitHub Pages Live", role: "Live production helper dashboard with real-time Azure Files cloud synchronization." },
    { category: "Chrome Terminal / Dev", title: "agy · chromeTerminal", icon: "🌐", platform: "Antigravity CLI IDE", role: "Antigravity (AGY) browser-based terminal at 127.0.0.1:3847 for local agentic workflows." },
    { category: "Web App / Website", title: "3-Minute AI Animation Video Production Suite 🎬 | Helpe", icon: "🌐", platform: "Local Development Suite", role: "Local dev environment (file:///.../index.html) for testing new pipeline features." }
  ],
  azureConfig: {
